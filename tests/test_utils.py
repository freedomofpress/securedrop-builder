...
def test_get_requirements_names_and_versions():
    expected_output = [("beautifulsoup4", "4.12.2"), ("colorama", "0.4.6"), ("cowsay", "6.0"), ("soupsieve", "2.5")]
...
def test_get_poetry_hashes():
    ...
    expected_keys = ['beautifulsoup4==4.12.2', 'colorama==0.4.6', 'cowsay==6.0', 'soupsieve==2.5']
